...
class ProductCard extends StatefulWidget {
  ...
  ProductCard({super.key, required this.instrument});
...
class _ProductCardState extends State<ProductCard> {
  ...
  Container details_product() {
    final productProvider = Provider.of<InstrumentosProvider>(context);
    return Container(
        ...
        children: [
          ...
          Container(
            child: ElevatedButton(
              ...
              onPressed: () {
                productProvider.addProductCar(widget.instrument);
  ...
  ClipRRect _backgroundImage() => ClipRRect(
        ...
        child: Container(
          ...
          child: FadeInImage(
            ...
            image: NetworkImage(widget.instrument.imagenUrl ?? ""),
            fit: BoxFit.cover,
          ),
        ),
      );
